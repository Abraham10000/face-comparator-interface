...
// c'est un component que j'ai crée pour faciliter la mise en plage du page Event.
        ...
        <div className="solution_cards_box">
          <div className="solution_card">
            ...
            <div className="solu_description">
              ...
              <h6>Duration : ...</h6> 
              <h6 style={{marginLeft : "100px"}}>Location : ...</h6>
              <h6 style={{marginLeft : "100px"}}>Group Participant : ...</h6>
              </div> <br />
              <br />
